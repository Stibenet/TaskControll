<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TasksListDir.aspx.cs" Inherits="TaskControll.TasksListDir" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        ...
        <tr>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [responsible] FROM [FXDPlan]"></asp:SqlDataSource>
                ...
                <asp:GridView ID="myGridview" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtNameFooter" runat="server" Height="40px" Width="250px" TextMode="MultiLine"></asp:TextBox>
                                <br />
                        ...
                        <asp:TemplateField>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtResponsibleFooter" runat="server" Height="40px" Width="250px" TextMode="MultiLine"></asp:TextBox>
                                <br />
                        ...
                        <asp:TemplateField>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtExecutorFooter" runat="server" Height="40px" Width="250px" TextMode="MultiLine"></asp:TextBox>
                                <br />
                        ...
                        <asp:TemplateField>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtDepartmentFooter" runat="server" Height="40px" Width="250px" TextMode="MultiLine"></asp:TextBox>
                                <br />
                        ...
                        <asp:TemplateField>
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="txtReportFooter" runat="server" Height="120px" Width="270px" TextMode="MultiLine"></asp:TextBox>
                                <br />
        ...
        <asp:Panel ID="Panel2" runat="server">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                        ...
                        DataKeyNames="Id"
                        CssClass="myGrid" HeaderStyle-CssClass="header" RowStyle-CssClass="trow1"
                        AlternatingRowStyle-CssClass="trow2" OnRowCommand="myGridview_RowCommand" OnRowEditing="myGridview_RowEditing" OnRowDeleting="myGridview_RowDeleting" OnRowUpdating="myGridview_RowUpdating" DataSourceID="SqlDataSource3">
                    <AlternatingRowStyle CssClass="trow2"></AlternatingRowStyle>
                    <Columns>
                        <%--                            <asp:TemplateField>
                                <ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [FXDPlan] WHERE ([responsible] = @responsible)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList3" Name="responsible" PropertyName="SelectedValue" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </asp:Panel>
